...
11. **Ordenar:**
    >**Observação:** Select para ordenar por *(nome_contribuinte, valor_cota, Numero_DAM's, vencimento DAM'S, Apelido_receita(IPTU, TFF, ISS e outros) e valor_pago)* apenas uma escolha de organização, 'orde by'. 
